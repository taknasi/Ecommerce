            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <span class="avatar avatar-online">
                                <img style="height: 35px;" src="{{ asset('assets/admin/images/user.png') }}"
                                    alt="avatar"><i></i></span>
                        </a>
                    ...
                    <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link"
                            ...
                            aria-expanded="false"><i class="flag-icon @if(app()->getLocale()=='en') flag-icon-gb @else flag-icon-sa  @endif "></i><span
                                class="selected-language"></span></a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            <a class="dropdown-item"
                                href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}">
                                <i class="flag-icon flag-icon-gb"></i> {{ __('msg.English') }}</a>

                            <a class="dropdown-item"
                                href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}">
                                <i class="flag-icon flag-icon-sa"></i> {{ __('msg.Arabic') }}</a>
                        </div>
                    </li>
