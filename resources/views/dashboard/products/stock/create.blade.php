                                            ...
                                            <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="manage_stock" class="select2 form-control" id="manageStock">
                                                                <optgroup label="من فضلك أختر النوع ">
                                                                    ...
                                                                    <option value="0" @if ($product->manage_stock!=1) selected @endif>عدم اتاحه التتبع</option>
                                                                </optgroup>
                                                            </select>
                                                            @error('manage_stock')
                                                            <span class="text-danger"> {{$message}}</span>
                                                ...
                                                <div class="row">
                                                  <!-- QTY  -->
                                                    ...
                                                    <div class="col-md-6"  @error("qty") style="display:block" @enderror style="display:none"  id="qtyDiv">
                                                        <div class="form-group">
